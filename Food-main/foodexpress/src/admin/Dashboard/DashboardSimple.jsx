            ...
            <div className="metric-card blue">
              <div className="metric-header">
                <div className="metric-info">
                  ...
                  <p className="metric-value">{stats?.total_Commandes?.value ?? ''}</p>
                </div>
            ...
            <div className="metric-card green">
              <div className="metric-header">
                <div className="metric-info">
                  ...
                  <p className="metric-value">{stats?.revenue_today?.value ?? ''}</p>
                </div>
                <span className="metric-icon">💰</span>
              </div>
              <p className="metric-trend positive">
                <FaArrowUp />{stats?.revenue_today?.trend ?? ''}
              </p>
            </div>
            ...
            <div className="metric-card orange">
              <div className="metric-header">
                <div className="metric-info">
                  ...
                  <p className="metric-value">{stats?.active_Commandes?.value ?? ''}</p>
                </div>
                <span className="metric-icon">🚀</span>
              </div>
            ...
            <div className="metric-card purple">
              <div className="metric-header">
                <div className="metric-info">
                  ...
                  <p className="metric-value">{stats?.new_customers?.value ?? ''}</p>
                </div>
                <span className="metric-icon">👥</span>
              </div>
              <p className="metric-trend positive">
