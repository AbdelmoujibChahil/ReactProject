...
const statusMeta = {
  ...
  delivering: { color: "#3b82f6", icon: <FaTruck /> },
  preparing: { color: "#f59e0b", icon: <FaClock /> },
  pending: { color: "#6b7280", icon: <FaHourglassHalf /> },
  canceled: { color: "#ef4444", icon: <FaTimesCircle /> },
};
    ...
    <div className="order-status-card">
      ...
      <div className="order-status-bars">
        {data.distribution.map((order, index) =>{
          const meta = statusMeta[order.statut];    // récupère icon + color
       return  (
          <div key={index} className="status-row">
            ...
            <div className="status-label">
              ...
              <span className="status-name">{order.statut}</span>
            </div>
