    ...
    const fetchRevenue = async () => {
      ...
      try {
       ...
       console.log(data);
        ...
        console.log(total)
        const average = data.data.length ? Math.round(total / data.data.length) : 0;
  ...
  const options = {
    ...
    plugins: {
      ...
      tooltip: {
        ...
        bodyFont: { size: 13 },
        callbacks: {
          label: (context) => `Revenue: ${context.parsed.y.toLocaleString()} DH`,
          afterLabel: (context) => {
            const avgOrderValue = (context.parsed.y / 125).toFixed(2);
            return `Avg Order: ${avgOrderValue} DH`;
          },
        },
      },
    },
    ...
    <div className="revenue-trends-card">
      ...
      <div className="chart-header">
        ...
        <div className="period-selector">
          ...
          >
            <option value="1day">Today (Hourly)</option>
          ...
          <div className="chart-stats">
            <div className="stat-item">
              ...
              <p className="stat-value total">
                {chartData.total.toLocaleString()} DH
              </p>
            </div>
            ...
            <div className="stat-item">
              ...
              <p className="stat-value average">
                {chartData.average.toLocaleString()} DH
              </p>
            </div>
