...
//ADD New
  ...
  const handleChangeStatus = async (driverId, newStatus) => {
    try {
      ...
      const response = await ClientApi.DriverupdateStatus(
        driverId,
                      ...
                      <tr className="driver-row">
                        ...
                        <td>
                          <span
                            ...
                            style={{
                              backgroundColor: statusStyles[driver.status]?.bg || "#f3f4f6",
                              color: statusStyles[driver.status]?.text || "#374151",
                            }}
                          >
                                      ...
                                      (status) => (
                                        <button
                                          ...
                                          className={`dropdown-item status ${
                                            getStatusDisplay(driver.status) === status
                                              ? "selected"
                                              : ""
                                          }`}
                                        >
                          ...
                          <td colSpan="8">
                            <div className="expanded-content">
                              <div className="expanded-section">
                                ...
                                {driver.email && (
                                  <p className="section-detail">{driver.email}</p>
                                )}
                              </div>
                              <div className="expanded-section">
