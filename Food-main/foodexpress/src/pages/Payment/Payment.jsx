      ...
      <div className="summary-items">
        {cartItems.map(item => (
          <div key={item.plat_id} className="summary-item">
            <img src={item.plat.image} alt={item.plat.nom} className="summary-item-image" />
          ...
          <div className="payment-methods">
            ...
            >
              ...
              <div className="payment-option-content">
                ...
                <div className="payment-option-desc">Pay with cash when your order arrives</div>
              </div>
            </div>
            ...
            >
              ...
              <div className="payment-option-content">
                ...
                <div className="payment-option-desc">Pay securely with your card</div>
              </div>
            </div>
          </div>
